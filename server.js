...
// Token push per stanza: { roomCode: [ { token, deviceId } ] }
const pushTokens = {};
...
// ─── Salva note + invia notifiche push agli altri dispositivi ─────────────────
app.post('/notes/:roomCode', async (req, res) => {
  ...
  // Manda notifica solo per nuova lista o modifica (non per toggle spunta)
